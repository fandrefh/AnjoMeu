...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GetPayment.user'
        db.delete_column(u'campaign_getpayment', 'user_id')

        # Adding field 'GetPayment.user_c'
        db.add_column(u'campaign_getpayment', 'user_c',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GetPayment.user'
        db.add_column(u'campaign_getpayment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'GetPayment.user_c'
        db.delete_column(u'campaign_getpayment', 'user_c_id')
