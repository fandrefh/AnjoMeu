...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GetPayment'
        db.create_table(u'campaign_getpayment', (
        ...
        db.send_create_signal(u'campaign', ['GetPayment'])


    def backwards(self, orm):
        # Deleting model 'GetPayment'
        db.delete_table(u'campaign_getpayment')
