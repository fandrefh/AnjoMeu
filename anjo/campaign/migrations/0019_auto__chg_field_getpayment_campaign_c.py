...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GetPayment.campaign_c'
        db.alter_column(u'campaign_getpayment', 'campaign_c_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Campaign'], null=True))

    def backwards(self, orm):

        # Changing field 'GetPayment.campaign_c'
        db.alter_column(u'campaign_getpayment', 'campaign_c_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['campaign.Campaign']))
    ...
    models = {
        ...
        u'campaign.getpayment': {
            ...
            'campaign_c': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['campaign.Campaign']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
