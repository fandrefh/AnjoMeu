...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Testimonials.created_at'
        db.add_column(u'core_testimonials', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Testimonials.created_at'
        db.delete_column(u'core_testimonials', 'created_at')
