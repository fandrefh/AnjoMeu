...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Banks'
        db.create_table(u'core_banks', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code_bank', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=70)),
        ))
        db.send_create_signal(u'core', ['Banks'])


    def backwards(self, orm):
        # Deleting model 'Banks'
        db.delete_table(u'core_banks')
    ...
    models = {
        ...
        u'core.banks': {
            ...
            'code_bank': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'core.howitwork': {
