...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_banks', 'code_bank', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Banks.code_bank'
        db.alter_column(u'core_banks', 'code_bank', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'core.banks': {
            ...
            'code_bank': ('django.db.models.fields.PositiveIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'core.howitwork': {
