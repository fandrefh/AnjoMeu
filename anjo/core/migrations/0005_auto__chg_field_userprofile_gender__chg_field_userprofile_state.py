...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'UserProfile.state'
        db.alter_column(u'core_userprofile', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'UserProfile.gender'
        db.alter_column(u'core_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'UserProfile.state'
        db.alter_column(u'core_userprofile', 'state', self.gf('django.db.models.fields.CharField')(max_length=1))
